...
# https://github.com/kenorb/kenorb/blob/573f2210e7c325108041d8f347846755855b442b/scripts/python/Quartz/click_via_pid.py
...
def click_via_pid(pid, x, y, button=LEFT):
    pressEvent = Quartz.CGEventCreateMouseEvent(None, mouseUp[button], (x, y), button )
    releaseEvent = Quartz.CGEventCreateMouseEvent(None, mouseDown[button], (x, y), button )
